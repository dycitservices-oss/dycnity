        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/5 p-10 lg:p-16 bg-slate-900 dark:bg-black text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              >
                Connect with our dedicated Sales Team at DYCNITY and unlock a tailored experience designed to meet your business needs.
              </motion.p>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-lg">dsupport@dycnity.com</p>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-lg">DYCNITY Technologies LLC
Building Number PR1005-OF605
Port Saeed, Plot No 347-0, Dubai, UAE</p>
                  </div>
                </motion.div>
              </motion.div>
            </div>
