      ...
      <div className="pt-10">
        ...
        >
           ...
           <div className="relative z-10">
             <SectionHeader title="Who We Are" subtitle="About DYCNITY" align="left" />
             <div className="text-lg text-slate-600 dark:text-slate-300 space-y-6 max-w-4xl">
               <p>
                 DYCNITY IT Consulting & Services is a technology-driven consulting firm delivering end-to-end digital transformation solutions. With deep domain expertise and a strong engineering mindset, we empower businesses to modernize systems, increase efficiency, and deliver superior customer experiences.
               </p>
               <p>
