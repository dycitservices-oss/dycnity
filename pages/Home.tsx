        ...
        >
          <motion.h1 variants={fadeInUp} className="text-5xl lg:text-7xl font-bold text-slate-900 dark:text-white tracking-tight mb-8">
            ...
            <TextFlip
              words={phrases}
              interval={2500}
              className="min-h-[1.2em] text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 dark:from-indigo-400 dark:via-purple-400 dark:to-pink-400"
            />
          </motion.h1>
          <motion.p variants={fadeInUp} className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed">
            At DYCNITY, we help organizations transform, optimize, and innovate through world-class technology consulting, enterprise solutions, and scalable digital platforms.
          </motion.p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <motion.div whileHover={{ scale: 1.05 }} className="bg-pink-500 p-6 rounded-3xl shadow-lg text-white">
                   ...
                   <p className="text-sm opacity-80 font-medium">Expert Team</p>
                </motion.div>
              </div>
