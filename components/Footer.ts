    ...
    <footer className="bg-slate-900 text-white pt-16 pb-8 rounded-t-[3rem] mt-20 mx-0 md:mx-4">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl tracking-tight">DYCNITY <span className="text-sm">Technologies LLC</span></span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              ...
              <li>End-to-End SWIFT Services</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>Building Number PR1005-OF605<br />Port Saeed, Plot No 347-0, Dubai, UAE</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <li className="flex items-center gap-3">
                <Mail className="shrink-0 text-indigo-400" size={18} />
                <a href="mailto:support@dycnity.com" className="hover:text-white">support@dycnity.com</a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
          <p>&copy; {new Date().getFullYear()} DYCNITY Technologies LLC All rights reserved.</p>
